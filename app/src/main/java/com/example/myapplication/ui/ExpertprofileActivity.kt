    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        databaseRefrence.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                binding.tvClinicaddress.text =  snapshot.child(expertid.toString()).child("clinic").child("clinic address").getValue<String>()
                lat = snapshot.child(expertid.toString()).child("clinic").child("clinic lat").getValue<String>().toString()
                long = snapshot.child(expertid.toString()).child("clinic").child("clinic long").getValue<String>().toString()
